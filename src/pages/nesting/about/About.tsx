      ...
      <div className="about">
        ...
        <div className="about__selfSectionWrapper">
          <p className="about__myselfSection">
            ...
            and backend developer with almost one years of web experience
            building websites. I am passionate about web development in all
            forms and like building apps that can help others. I have created -
            and improved - dozens of successful web applications/websites that
            have reached 200 users. And I have worked with individuals and
            companies. I maintain an unwavering dedication to continuous
            self-improvement. I continually expand my skill set by exploring
            diverse platforms, frameworks, and programming languages. Outside of
            work I am constantly teaching myself and learning how to build apps
            with various platforms, frameworks, languages, etc. My other hobbies
            include: Robotics, Math, checkers, and more!
          </p>
        </div>
        {/* SKILLS SECTION */}
